...
function resize(currentScore, finalScore, duration, callback) {
  ...
  document.getElementById("dinosaur").style =
                          `width: ${9-0.9*currentScore}rem;`;
  ...
  if (duration > 30) {
    ...
    setTimeout(function() {resize(finalScore, finalScore, 0, callback)}, duration);
  } else {
...
function Question() {
  ...
  this.display = function() {
    ...
    document.getElementById("submit-button")
      .addEventListener("click", evaluateAnswer);
  }
}
